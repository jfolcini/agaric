          ...
          {group.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm text-popover-foreground hover:bg-accent hover:text-accent-foreground transition-colors [@media(pointer:coarse)]:min-h-[44px]',
                  item.className,
                )}
                onClick={item.action}
              >
