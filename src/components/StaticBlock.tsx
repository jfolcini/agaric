...
export function StaticBlock({
  ...
  return (
    <button
      type="button"
      className="block-static flex w-full min-h-[2.5rem] cursor-text rounded-md px-3 py-1.5 text-left text-sm transition-colors hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
