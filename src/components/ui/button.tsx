  ...
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-md text-sm font-medium whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-[1.2em]",
  {
    variants: {
      ...
      size: {
        ...
        xs: "h-6 gap-1 rounded-md px-2 text-xs [&_svg:not([class*='size-'])]:size-3 [@media(pointer:coarse)]:h-10 [@media(pointer:coarse)]:px-3",
        sm: 'h-8 gap-1.5 rounded-md px-3 [@media(pointer:coarse)]:h-10',
        lg: 'h-10 rounded-md px-6',
        icon: 'size-9 [@media(pointer:coarse)]:size-11',
        'icon-xs':
          "size-6 rounded-md [&_svg:not([class*='size-'])]:size-3 [@media(pointer:coarse)]:size-10",
        'icon-sm': 'size-8 [@media(pointer:coarse)]:size-10',
        'icon-lg': 'size-10',
      },
    },
    defaultVariants: {
