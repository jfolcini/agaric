...
// `calc(100dvh-4rem)` fallback keeps a sane cap where the var is unset (jsdom,
// `avoidCollisions={false}`). `AddFilterPopover` already used this var
// directly; the primitive now does it for every popover.
...
/**
 * Default collision padding (#4313).
 *
 ...
 *
 * 4 px on the other three sides so a popover never sits flush against an edge.
 */
