 ...
 * value `agaric:space-onboarding-seen-v1` exactly. Sourced from
 * `PREFERENCES.spaceOnboardingSeen` (#2466) — the single source of truth
 * for the literal key string.
 */
export const ONBOARDING_STORAGE_KEY = PREFERENCES.spaceOnboardingSeen.key
...
export function readOnboardingSeen(): boolean {
  return readPreference(PREFERENCES.spaceOnboardingSeen)
}

function writeOnboardingSeen(): void {
  writePreference(PREFERENCES.spaceOnboardingSeen, true)
}
...
export function resetOnboardingSeen(): void {
  removePreference(PREFERENCES.spaceOnboardingSeen)
}
