...
export const block: Record<string, string> = {
  ...
  'status.snapshotSending': 'Sending snapshot…',
  'status.snapshotReceiving': 'Receiving snapshot…',
  'status.snapshotComplete': 'Snapshot complete',
  'status.snapshotPercent': '{{percent}}%',
  'status.snapshotProgressLabel': 'Snapshot transfer progress',
