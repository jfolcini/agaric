...
// ---------------------------------------------------------------------------
// #754 — pageStack depth cap. `navigateToPage` appends one entry per HOP, so
// a long browsing session grows the stack (and the persisted blob) without
// bound. The cap drops the OLDEST entry.
// ---------------------------------------------------------------------------
