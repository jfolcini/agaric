...
//! (`batch_resolve_inner`, `get_page_inner`) in `agaric_lib::commands`, which live
...
mod tests_p7 {
    ...
    use agaric_lib::commands::{batch_resolve_inner, get_page_inner};
...
mod block_row_canonical_conformance {
    ...
    fn block_row_canonical_query_as_sites_match_canonical_columns() {
        ...
        // module file (`src-tauri/tests/app_tests/pagination_app_tests.rs`),
        // so the app sites reach back into the crate via `../../src/…` and the
        // `agaric-store` / `agaric-engine` sites via `../../<crate>/src/…`
        // (#2621, wave S4b; #4499 phase 0d moved this file out of `src/`).
        let sources: &[(&str, &str)] = &[
            (
                "commands/blocks/crud.rs",
                include_str!("../../src/commands/blocks/crud.rs"),
            ),
            ...
            (
                ...
                include_str!("../../src/commands/blocks/queries.rs"),
            ),
            (
                "commands/journal.rs",
                include_str!("../../src/commands/journal.rs"),
            ),
            (
                "commands/pages/markdown.rs",
                include_str!("../../src/commands/pages/markdown.rs"),
            ),
            (
                "commands/pages/listing.rs",
                include_str!("../../src/commands/pages/listing.rs"),
            ),
            (
                "commands/properties.rs",
                include_str!("../../src/commands/properties.rs"),
            ),
            (
            ...
            (
                ...
                include_str!("../../src/recurrence/compute.rs"),
            ),
