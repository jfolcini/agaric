...
//! (`agaric_lib::commands::queries::{search_blocks_partitioned_inner,
...
async fn test_pool() -> (SqlitePool, TempDir) {
    ...
    let pool = agaric_lib::db::init_pool(&db_path).await.unwrap();
    (pool, dir)
}
...
async fn partitioned_happy_path_pages_and_blocks_within_caps() {
    ...
    let resp = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool,
...
async fn partitioned_has_more_flags_reflect_partition_overflow() {
    ...
    let tight = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool,
        "partitioned".to_string(),
        2,
        3,
    ...
    let loose = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool,
        "partitioned".to_string(),
        20,
        20,
...
async fn partitioned_ignores_block_type_filter_in_filter_struct() {
    ...
    let baseline = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool,
        "partitioned".to_string(),
        10,
        10,
    ...
    let with_filter = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool,
        "partitioned".to_string(),
        10,
        10,
...
async fn concurrent_partitioned_searches_do_not_deadlock_or_starve() {
    ...
    let fut0 = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool0,
        "partitioned".to_string(),
        8,
        40,
    ...
    let fut1 = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool1,
        "partitioned".to_string(),
        8,
        40,
    ...
    let fut2 = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool2,
        "partitioned".to_string(),
        8,
        40,
    ...
    let fut3 = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool3,
        "partitioned".to_string(),
        8,
        40,
    ...
    let fut4 = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool4,
        "partitioned".to_string(),
        8,
        40,
...
async fn concurrent_pool_starvation_bound_500ms() {
    ...
    let h0 = tokio::spawn(async move {
        ...
        let _ = agaric_lib::commands::queries::search_blocks_partitioned_inner(
            &p0,
            "partitioned".to_string(),
            10,
            10,
...
async fn partitioned_over_long_query_is_rejected() {
    ...
    let err = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool,
        huge,
        10,
        10,
...
async fn cancellation_drops_in_flight_query() {
    ...
    let start = std::time::Instant::now();
    let result = agaric_lib::commands::queries::search_blocks_partitioned_inner(
        &pool,
        "partitioned".to_string(),
        50,
        50,
    ...
    let handle = tokio::spawn(async move {
        ...
        let res = agaric_lib::commands::queries::search_blocks_partitioned_inner(
            &pool_clone,
            "partitioned".to_string(),
            50,
            50,
...
async fn rapid_fire_burst_pattern_does_not_starve_pool() {
    ...
    let mut handles: Vec<(
        tokio::task::JoinHandle<
            Result<
                agaric_lib::commands::queries::PartitionedSearchResponse,
...
async fn be_a10_sqla1_cursor_rejects_over_cap_limit() {
    ...
    let err = agaric_lib::commands::queries::search_blocks_inner(
        &pool,
        "sqla1".to_string(),
        None,
        Some(over),
    ...
    let ok_cap = agaric_lib::commands::queries::search_blocks_inner(
        &pool,
        "sqla1".to_string(),
        None,
    ...
    let ok_default = agaric_lib::commands::queries::search_blocks_inner(
        &pool,
        "sqla1".to_string(),
        None,
        None,
