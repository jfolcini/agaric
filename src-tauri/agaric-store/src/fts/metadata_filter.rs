...
use crate::search_types::{DateFilter, DateOp, NamedDateRange, SearchFilter, SearchPropertyFilter};
...
mod tests {
    use super::*;
    use crate::search_types::{NamedDateRange, SearchFilter, SearchPropertyFilter};
