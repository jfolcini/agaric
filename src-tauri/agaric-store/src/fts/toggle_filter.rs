...
use crate::search_types::{MatchOffset, SearchBlockRow};
...
struct RegexScanRow {
    ...
    parent_id: Option<agaric_core::ulid::BlockId>,
    position: Option<i64>,
...
impl RegexScanRow {
    ...
    fn into_search_row(
        ...
        SearchBlockRow {
            id: agaric_core::ulid::ActiveBlockId::from_trusted_active(self.id.as_str()),
            block_type: self.block_type,
            content,
            parent_id: self.parent_id.map(agaric_core::ulid::BlockId::into_string),
