...
pub(super) struct FtsSearchRow {
    // Block fields
    pub(super) id: agaric_core::ulid::BlockId,
    pub(super) block_type: String,
    pub(super) content: Option<String>,
    pub(super) parent_id: Option<agaric_core::ulid::BlockId>,
...
pub(super) fn fts_row_to_block_row(r: FtsSearchRow) -> SearchBlockRow {
    SearchBlockRow {
        ...
        id: agaric_core::ulid::ActiveBlockId::from_trusted_active(r.id.as_str()),
        block_type: r.block_type,
        content: r.content,
        parent_id: r.parent_id.map(agaric_core::ulid::BlockId::into_string),
        position: r.position,
