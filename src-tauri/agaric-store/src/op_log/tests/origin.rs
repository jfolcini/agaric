...
// NOTE (#2621, wave S3b-ii): four origin tests that couple to the app-only
// `mcp::actor` scope machinery and `dag::insert_remote_op`
// (`append_inside_agent_scope_stamps_origin_agent_prefix`,
