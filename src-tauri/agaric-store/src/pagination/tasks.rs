...
pub async fn list_unfinished_tasks(
    ...
    let raw_rows = sqlx::query!(
        r#"SELECT b.id as "id!: agaric_core::ulid::BlockId", b.block_type, b.content, b.parent_id as "parent_id: agaric_core::ulid::BlockId", b.position,
                b.deleted_at,
                b.todo_state, b.priority, b.due_date, b.scheduled_date,
                b.page_id as "page_id: agaric_core::ulid::BlockId", COALESCE(b.due_date, b.scheduled_date) as "sort_date: String"
         FROM blocks b
