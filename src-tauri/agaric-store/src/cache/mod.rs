...
where
    F: FnOnce() -> Fut,
    Fut: std::future::Future<Output = Result<u64, agaric_core::error::AppError>>,
{
...
pub use block_links::{
    LinkBackfill, backfill_block_links, rebuild_block_links_unresolved, reindex_block_links,
