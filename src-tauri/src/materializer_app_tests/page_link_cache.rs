...
async fn set_block_page_id_rollup_repair_survives_a_failed_reindex_3842() {
    ...
    let result = crate::materializer::handle_background_task_metered(
        &pool,
        &task,
        None,
        None,
...
async fn set_block_page_id_page_to_page_move_degrades_instead_of_panicking_3909() {
    ...
    crate::materializer::handle_background_task(
        &pool,
...
async fn a_failed_referrer_relink_is_owed_durably_4118() {
    ...
    crate::materializer::handle_background_task_metered(&pool, &task, None, None, mat.metrics())
        .await
        .expect(
...
/// the repair goes (`reindex_restored_cohort_links`).
///
