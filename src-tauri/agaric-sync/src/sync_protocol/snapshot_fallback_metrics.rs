...
//! aggregate, mirroring the `materializer::handlers::sql_only_fallback` (app-side)
...
///
/// The production read side is `materializer::coordinator` (app-side)'s
...
pub fn last() -> Option<SnapshotFallbackLast> {
