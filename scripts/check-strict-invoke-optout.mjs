...
// it there. At 0.13.0 `remove-after-markers` fails on this line: convert
// the remaining opt-outs to `vi.fn(strictInvokeFallback)` and delete this
// block, or bump the version and say in the diff why not.
//
