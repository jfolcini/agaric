...
- **Three `outline-none` focus-ring fixes** (L12): JournalPage / UnlinkedReferences / App.tsx now carry the standard `focus-visible:outline-hidden focus-visible:ring-[3px] focus-visible:ring-ring/50` pattern instead of bare `outline-none`. (M6 focus-ring utility extraction across 50+ sites is still pending — separate dedicated session.)
