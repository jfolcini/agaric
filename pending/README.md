...
| scale-benchmarks-100k-2026-05-14 | Latency-assertion gate + close bench gaps (history, graph @ 100K, agenda expansion) for the sub-200ms interactive SLO; carves Problem-command fixes (`list_page_links`, `list_projected_agenda`) into follow-up plans | S + M (Phase 1+2), L deferred | draft |
