...
| scale-benchmarks-100k-2026-05-14 | Open: Phase 3 — carve `list_page_links` materialization + `list_projected_agenda` SQL pushdown into their own follow-up plans now that 100K benches + SLO row are in place. | L (per follow-up plan) | partial-shipped (Phases 1+2 done in sessions 742+744) |
