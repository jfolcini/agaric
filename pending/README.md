...
| design-system-ux-review-2026-05-09 | Audit: cross-screen composition + doc/code drift. Tier 1 items 4, 5, 8 (badge consolidation, FeaturePageHeader, IconButton primitive) + Tier 2 D2/D4 + structural Tier 3 (component decomposition, FeatureErrorBoundary in-view, list-primitive zoo) still open. Item 11 (`ConfirmDialog` + `ConfirmDestructiveAction` merge) closed 2026-05-14. | M-L | partial-shipped, plan stays for follow-up |
