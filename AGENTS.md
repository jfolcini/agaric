...
- **Names do the explaining.** A comment says why, never what; when the what needs a comment, rename. No history in code: an issue number is the pointer, the rest lives in the issue.
