...
- **iroh transport** — scoped, not started. Approved adoption plan replacing the mDNS + WebSocket + TLS + TOFU stack with a higher-level p2p library. See `pending/PEND-10-iroh-transport-adoption.md`.
