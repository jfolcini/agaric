...
The boundary to remember: **the content of a note is never stale; the indexes that help you find or count it can be.** Opening a page you just edited always shows the edit; searching for it, seeing it in the agenda, or seeing an updated backlink/count is re-offered at least every 5 min after a drop-then-persist event, or every 1 h while the rebuild keeps erroring.
