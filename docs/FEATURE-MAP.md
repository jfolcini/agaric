...
| **Embeds** | `{{embed ((ULID))}}` renders a block's or page's subtree inline on another page, live and read-only, in a bordered container with a source breadcrumb, an Open-source route, cycle and depth stubs. | [features/tags-and-links.md](features/tags-and-links.md) |
