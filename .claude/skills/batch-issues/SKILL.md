...
A note earns a place in it on the same terms as any other finding (§4). A note whose premise is wrong is not silently dropped — say so in the PR body and in the log, with what you checked. A note that earns none of §4's dispositions gets nothing; do not manufacture churn to close the loop on every bullet.
